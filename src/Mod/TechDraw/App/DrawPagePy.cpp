...
PyMethodDef DrawPagePy::Methods[] = {
    ...
    {"getPageWidth",
        reinterpret_cast<PyCFunction>( staticCallback_getPageWidth ),
        METH_VARARGS,
        "Return the width of this page"
    },
    {"getPageHeight",
        reinterpret_cast<PyCFunction>( staticCallback_getPageHeight ),
        METH_VARARGS,
        "Return the height of this page"
    },
    {"getPageOrientation",
        reinterpret_cast<PyCFunction>( staticCallback_getPageOrientation ),
        METH_VARARGS,
...
// getPageWidth() callback and implementer
// PyObject*  DrawPagePy::getPageWidth(PyObject *args){};
// has to be implemented in DrawPagePyImp.cpp
PyObject * DrawPagePy::staticCallback_getPageWidth (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getPageWidth' of 'TechDraw.DrawPage' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DrawPagePy*>(self)->getPageWidth(args);
        if (ret != 0)
            static_cast<DrawPagePy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// getPageHeight() callback and implementer
// PyObject*  DrawPagePy::getPageHeight(PyObject *args){};
// has to be implemented in DrawPagePyImp.cpp
PyObject * DrawPagePy::staticCallback_getPageHeight (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getPageHeight' of 'TechDraw.DrawPage' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DrawPagePy*>(self)->getPageHeight(args);
        if (ret != 0)
            static_cast<DrawPagePy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// getPageOrientation() callback and implementer
// PyObject*  DrawPagePy::getPageOrientation(PyObject *args){};
// has to be implemented in DrawPagePyImp.cpp
PyObject * DrawPagePy::staticCallback_getPageOrientation (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getPageOrientation' of 'TechDraw.DrawPage' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DrawPagePy*>(self)->getPageOrientation(args);
        if (ret != 0)
            static_cast<DrawPagePy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
